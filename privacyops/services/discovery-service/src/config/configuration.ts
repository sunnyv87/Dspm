...
export default (): AppConfig => ({
  ...
  database: {
    ...
    database: process.env.DB_DATABASE || 'privacyops_discovery',
  ...
  redis: {
    ...
    keyPrefix: process.env.REDIS_KEY_PREFIX || 'discovery:',
  },
  ...
  kafka: {
    ...
    clientId: process.env.KAFKA_CLIENT_ID || 'discovery-service',
    groupId: process.env.KAFKA_GROUP_ID || 'discovery-service-group',
