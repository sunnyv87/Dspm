...
export default (): AppConfig => ({
  ...
  database: {
    ...
    database: process.env.DB_DATABASE || 'privacyops_consent',
  ...
  redis: {
    ...
    keyPrefix: process.env.REDIS_KEY_PREFIX || 'consent:',
  },
  ...
  kafka: {
    ...
    clientId: process.env.KAFKA_CLIENT_ID || 'consent-service',
    groupId: process.env.KAFKA_GROUP_ID || 'consent-service-group',
