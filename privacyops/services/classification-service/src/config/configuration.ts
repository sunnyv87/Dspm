...
export default (): AppConfig => ({
  ...
  database: {
    ...
    database: process.env.DB_DATABASE || 'privacyops_classification',
  ...
  redis: {
    ...
    keyPrefix: process.env.REDIS_KEY_PREFIX || 'classification:',
  },
  ...
  kafka: {
    ...
    clientId: process.env.KAFKA_CLIENT_ID || 'classification-service',
    groupId: process.env.KAFKA_GROUP_ID || 'classification-service-group',
  ...
  dspm: {
    ...
    dspmAdapterUrl: process.env.DSPM_ADAPTER_URL || 'http://localhost:3005',
    discoveryServiceUrl: process.env.DISCOVERY_SERVICE_URL || 'http://localhost:3007',
  },
});
