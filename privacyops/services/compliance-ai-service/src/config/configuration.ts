...
export default (): AppConfig => ({
  ...
  database: {
    ...
    database: process.env.DB_DATABASE || 'compliance_ai',
  ...
  redis: {
    ...
    keyPrefix: process.env.REDIS_KEY_PREFIX || 'compliance-ai:',
  },
  ...
  kafka: {
    ...
    clientId: process.env.KAFKA_CLIENT_ID || 'compliance-ai-service',
    groupId: process.env.KAFKA_GROUP_ID || 'compliance-ai-service-group',
  ...
  dspm: {
    serviceName: 'compliance-ai-service',
