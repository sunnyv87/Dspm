...
export default (): AppConfig => ({
  ...
  database: {
    ...
    database: process.env.DB_DATABASE || 'vendor_risk',
  ...
  redis: {
    ...
    keyPrefix: process.env.REDIS_KEY_PREFIX || 'vendor-risk:',
  },
  ...
  kafka: {
    ...
    clientId: process.env.KAFKA_CLIENT_ID || 'vendor-risk-service',
    groupId: process.env.KAFKA_GROUP_ID || 'vendor-risk-service-group',
  ...
  dspm: {
    serviceName: 'vendor-risk-service',
