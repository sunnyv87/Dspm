...
export default (): AppConfig => ({
  ...
  database: {
    ...
    database: process.env.DB_DATABASE || 'breach_monitoring',
  ...
  redis: {
    ...
    keyPrefix: process.env.REDIS_KEY_PREFIX || 'breach:',
  },
  ...
  kafka: {
    ...
    clientId: process.env.KAFKA_CLIENT_ID || 'breach-monitoring-service',
    groupId: process.env.KAFKA_GROUP_ID || 'breach-monitoring-service-group',
  ...
  dspm: {
    serviceName: 'breach-monitoring-service',
